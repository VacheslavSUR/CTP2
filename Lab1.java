...
public class Lab1 {
    public static void main(String[] args) {
        DecimalFormat ft = new DecimalFormat("#.##");//форматирование при выводе
        Point3d dot1 = new Point3d();//создание элемента класса
        ...
        if (dot1.Equals(dot2) || dot1.Equals(dot3) || dot2.Equals(dot3)) System.out.println("Some of the points are the same.");//проверка на разницу в координатах
        else
            System.out.println("Your triangle's area equals: " + ft.format(computeArea(dot1, dot2, dot3)));
    }
    public static double computeArea(Point3d a, Point3d b, Point3d c){//фунцкия нахождения площади по формуле Герона
